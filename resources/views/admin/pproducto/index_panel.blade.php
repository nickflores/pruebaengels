...
@section('content')
    <!-- Encabezado -->
        <div class="row pt-5">
            ...
            <a href="{{url("productos_")}}" target="_blank" class="btn btn-secondary text-white btn-sm"><i class="bi bi-eye-fill"></i></a>
                <h1 class="text-azul h2 text-uppercase fw-bold mb-0"> Productos</h1>
                <p class="text-muted">Se muestra informacion sobre productos</p>
            </div>
            <div class="col-lg-3 d-flex">
            <a href="{{url("productos/create")}}" class="btn btn-secondary w-100 align-self-center text-white mb-2 mb-md-0">
    ...
    {{-- contenido --}}
        ...
        <div class="row">
            <div class="col-12 my-2">
                <span class="mb-0 fw-bold text-primary text-uppercase">Productos</span>
        ...
        @foreach($Pproducto as $producto)
            <div class="col-12 col-md-4">
                <div class="card mb-3 border-0 rounded-0 bg-transparent">
                    <img src="/imagenes/Pproducto/{{$producto->imagen}}" class="card-img-top rounded img__nosotros" alt="...">
