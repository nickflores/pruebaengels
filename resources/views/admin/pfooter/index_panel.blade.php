...
@section('content')
   {{-- fin breacrumb --}}
    ...
    <div class="row">
        <div class="col-lg-9">
            <h1 class="text-secondary h2 text-uppercase fw-bold mb-0">DATOS PRINCIPALES DE TECNOBOTS</h1>
            <p class="text-muted">Se muestra los datos principales de TECNOBOTS</p>
        </div>
        <div class="col-lg-3 d-flex">
            <a href="{{url("perfil/1/edit")}}" class="btn btn-secondary w-100 align-self-center text-white mb-2 mb-md-0">
    ...
    <footer>
      <div class="footer-container">
        <div class="footer-seccion">
          <img src="/iconos/logo_1.png" alt="" class="logo-footer" />
          <p>
      ...
      <div class="copyright">
        ...
        <button>
          <img src="iconos/WhatsApp_icon1.png" alt="" class="wsp" />
        </button>
      </div>
    </footer>
